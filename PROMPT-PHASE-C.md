...
**Текущий план — `PROMPT-PHASE-D.md`.** Фаза C выполнена; выводы из неё (v2-схема кэша, Docling без OCR на сканах, зависание pipeline) разобраны и исправлены в апстриме. Ниже — исходное задание, оставлено для истории.

---

~~ФАЗА C (исходное задание)~~
